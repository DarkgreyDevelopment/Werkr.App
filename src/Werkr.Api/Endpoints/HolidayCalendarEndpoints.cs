...
internal static class HolidayCalendarEndpoints {
    ...
    public static WebApplication MapHolidayCalendarEndpoints( this WebApplication app ) {
        ...
        _ = app.MapGet( "/api/holiday-calendars", async (
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapPost( "/api/holiday-calendars", async (
        ...
        _ = app.MapPut( "/api/holiday-calendars/{id}", async (
            Guid id,
        ...
        _ = app.MapDelete( "/api/holiday-calendars/{id}", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapPost( "/api/holiday-calendars/{id}/clone", async (
            Guid id,
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}/rules", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}/rules/{ruleId}", async (
            Guid id,
            long ruleId,
            HolidayCalendarService service,
            CancellationToken ct ) => {
        ...
        _ = app.MapPost( "/api/holiday-calendars/{id}/rules", async (
            Guid id,
        ...
        _ = app.MapPut( "/api/holiday-calendars/{id}/rules/{ruleId}", async (
            Guid id,
            long ruleId,
        ...
        _ = app.MapDelete( "/api/holiday-calendars/{id}/rules/{ruleId}", async (
            Guid id,
            long ruleId,
            HolidayCalendarService service,
            CancellationToken ct ) => {
        ...
        _ = app.MapPost( "/api/holiday-calendars/rules/preview", (
            int startYear,
            int endYear,
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}/dates", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}/dates/{dateId}", async (
            Guid id,
            long dateId,
            HolidayCalendarService service,
            CancellationToken ct ) => {
        ...
        _ = app.MapPost( "/api/holiday-calendars/{id}/dates", async (
            Guid id,
        ...
        _ = app.MapPut( "/api/holiday-calendars/{id}/dates/{dateId}", async (
            Guid id,
            long dateId,
            HolidayDateCreateRequest request,
            HolidayCalendarService service,
        ...
        _ = app.MapDelete( "/api/holiday-calendars/{id}/dates/{dateId}", async (
            Guid id,
            long dateId,
            HolidayCalendarService service,
            CancellationToken ct ) => {
        ...
        _ = app.MapPost( "/api/holiday-calendars/{id}/dates/bulk", async (
            Guid id,
        ...
        _ = app.MapGet( "/api/holiday-calendars/{id}/preview", async (
            Guid id,
            int startYear,
            int endYear,
            HolidayCalendarService service,
        ...
        _ = app.MapGet( "/api/schedules/{id}/holiday-calendar", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapPut( "/api/schedules/{id}/holiday-calendar", async (
            Guid id,
        ...
        _ = app.MapDelete( "/api/schedules/{id}/holiday-calendar", async (
            Guid id,
            HolidayCalendarService service,
            CancellationToken ct ) => {
                try {
        ...
        _ = app.MapGet( "/api/schedules/{id}/holiday-dates", async (
            Guid id,
            DateOnly start,
            DateOnly end,
        ...
        _ = app.MapPost( "/api/schedules/{id}/audit-log", async (
            Guid id,
            ScheduleAuditLogCreateRequest request,
            HolidayCalendarService calService,
            Data.WerkrDbContext db,
            CancellationToken ct ) => {
                try {
                    ScheduleHolidayCalendar? link = await calService.GetScheduleCalendarAsync( id, ct );
                    if (link is null) {
        ...
        _ = app.MapGet( "/api/schedules/{id}/audit-log", async (
            Guid id,
            DateTime from,
            DateTime to,
            Data.WerkrDbContext db,
