...
public sealed class JobOutputWriter( IOptions<JobOutputOptions> options, ILogger<JobOutputWriter> logger ) {
    ...
    public void EnsureDirectoryExists( ) {
        if (!Directory.Exists( _outputDirectory )) {
            ...
            if (logger.IsEnabled( LogLevel.Information )) {
                logger.LogInformation( "Created job output directory: {Directory}", _outputDirectory );
            }
        }
    }
